package tech.haonan.svg_map_backend.config;
...
//        boolean flag = environment.acceptsProfiles(profiles); // 返回flag 如果 处于dev环境 flag就是true
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("tech.haonan.svg_map_backend.controller")) // 只扫描一部分包
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("地图geojson数据文档") // 标题
                .description("地图geojson数据文档") // 描述
                .termsOfServiceUrl("") //
